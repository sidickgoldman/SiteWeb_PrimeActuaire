...
export default function CTAFinal() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    setSending(true);
    // Build mailto fallback with pre-filled fields
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="mt-6 text-lg text-white/40 max-w-md leading-relaxed">
              20 minutes suffisent pour identifier les leviers. Remplissez le formulaire
              ...
              <form onSubmit={handleSubmit} className="bg-white/[0.04] border border-white/[0.08] rounded-2xl p-8 space-y-5">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Décrivez brièvement votre besoin ou le portefeuille concerné..."
                  />
                </div>
                <button
                  type="submit"
                ...
                <p className="text-[11px] text-white/15 text-center">
                  Ou directement : contact@primeactuaire.com
                </p>
              </form>
            )}
          </div>
