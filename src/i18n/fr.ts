export const fr = {
  ...
  aProposPage: {
    ...
    valeurs: [
      { icon: "", title: "Rigueur actuarielle", desc: "Chaque chiffre est traçable et défendable en comité.\nLes hypothèses sont documentées. Toujours." },
      { icon: "", title: "Focus exclusif", desc: "Santé collective en zone CIMA. Un seul métier.\nPas de diversification. Maîtrisé en profondeur." },
      { icon: "", title: "Vitesse de décision", desc: "15 minutes pour un diagnostic complet.\n3 jours en méthode manuelle.\nLe DT ne devrait pas attendre." },
      { icon: "", title: "Souveraineté des données", desc: "Vos données restent sous votre contrôle.\nServeur dédié. Conformité CIMA intégrale." },
    ],
