export const fr = {
  ...
  solution: {
    ...
    title: "Une solution conçue pour structurer la décision tarifaire.",
  ...
  insights: {
    eyebrow: "Insights",
    title: "Perspectives sur la santé collective.",
    allArticles: "Tous les articles →",
    readMore: "Lire →",
  },

  // APropos (homepage section)
  aPropos: {
    eyebrow: "À propos",
    titleLine1: "Un actuaire.",
    titleLine2: "Un outil. Une mission claire.",
    p1: "PrimeActuaire est né d'un constat simple : les directions techniques en zone CIMA prennent des décisions tarifaires majeures — souvent sans les outils adaptés pour les défendre.",
    p2: "J'ai construit cette plateforme après des années à modéliser des portefeuilles santé collective, à constater les mêmes dérives, les mêmes angles morts. L'objectif : donner aux DT et DG les moyens de décider avec des données, pas des intuitions.",
    facts: [
      { title: "Zone CIMA", subtitle: "Marché de spécialisation" },
      { title: "Santé collective", subtitle: "Focus exclusif" },
      { title: "Actuaire", subtitle: "Fondateur & praticien" },
      { title: "Outil + conseil", subtitle: "Approche intégrée" },
    ],
    philosophyLabel: "Philosophie",
    quote:
      "Un tarif technique doit être une position défendable — pas une opinion ajustée à la marge.",
    philosophyText:
      "Chaque fonctionnalité de la plateforme, chaque mission de conseil, répond à cette exigence : produire des analyses que le DT peut poser sur la table en comité et défendre face au courtier.",
  ...
  ctaFinal: {
    ...
    form: {
      ...
      societePlaceholder: "Nom de la compagnie d'assurance",
      message: "Message",
      messagePlaceholder:
        "Décrivez brièvement votre besoin ou le portefeuille concerné...",
      sending: "Envoi en cours...",
      send: "Envoyer le message",
    },
    success: {
      title: "Message envoyé",
      text: "Nous revenons vers vous sous 24h.",
    },
    directContact: "Ou directement :",
  },
  ...
  footer: {
    stats: [
      ...
      { value: "+8%/an", label: "Inflation médicale CIMA" },
    ...
    pillars: [
      {
        ...
        bullets: [
          ...
          "cadrer les remises",
          "arbitrer entre compétitivité et rentabilité",
        ],
        outcomeLabel: "Résultat",
        outcome: "Des décisions tarifaires assumées, pas subies.",
        toolNote: "Ces analyses s’appuient sur notre plateforme Tarif Santé Pro.",
      },
      {
        label: "Pilotage technique",
        ...
        bullets: [
          ...
          "distinguer dérive technique et problème opérationnel",
          "orienter les actions correctives",
        ],
        outcomeLabel: "Résultat",
        outcome: "Des actions ciblées, pas des corrections générales.",
        toolNote: "Ces analyses s’appuient sur notre plateforme Tarif Santé Pro.",
      },
      {
        ...
        bullets: [
          ...
          "formuler une position claire",
          "défendre les décisions en comité",
        ],
        outcomeLabel: "Résultat",
        outcome: "Des décisions solides, même sous pression.",
        toolNote: "Ces analyses s’appuient sur notre plateforme Tarif Santé Pro.",
      },
    ],
    whyTitle: "Pourquoi nous, plutôt qu’un actuaire interne et Excel.",
    whySubtitle: "La vraie question, posée franchement. Voici notre réponse.",
    whyItems: [
      {
      ...
      },
      {
        ...
        desc: "Nous n’arrêtons pas le travail au rendu. Nous suivons jusqu’à la mise en œuvre et le retour du marché.",
      },
    ],
  },
  ...
  plateformePage: {
    ...
    keyNumbers: [
      { value: "15 min", label: "pour objectiver une décision" },
      { value: "Plusieurs jours", label: "d'analyse manuelle" },
    ...
    workflowSteps: [
      ...
      { title: "Vous comprenez ce qui se passe vraiment.", desc: "La plateforme fait émerger les signaux.\nNous aidons à en lire les causes réelles." },
      { title: "Vous identifiez où agir.", desc: "Les dérives, fraudes ou abus deviennent lisibles.\nNous orientons les actions à mener." },
      { title: "Vous prenez position.", desc: "Les analyses sont chiffrées et structurées.\nNous aidons la direction à cadrer et défendre la décision." },
    ],
  ...
  aProposPage: {
    ...
    heroTitle: "L’outil et l’expertise que le marché CIMA attendait.",
    heroDesc: "L’expertise sans l’outil reste une opinion.\nL’outil sans l’expertise est un tableau de bord.\nPrimeActuaire, c’est les deux.",
    ...
    valeursEyebrow: "Valeurs",
    valeursTitle: "Les principes qui tiennent l’analyse, même sous pression.",
    promesseEyebrow: "Promesse",
    promesseTitle: "Ce que vous obtenez, concrètement.",
    valeurs: [
      { icon: "", title: "Confidentialité", desc: "Vos données ne quittent pas la relation." },
      { icon: "", title: "Rigueur", desc: "Chaque hypothèse est défendable en comité." },
      { icon: "", title: "Clarté", desc: "L’analyse parle. Pas le jargon." },
      { icon: "", title: "Engagement", desc: "On se mesure aux décisions prises, pas aux livrables." },
      { icon: "", title: "Indépendance", desc: "La réalité du portefeuille. Même sous pression." },
    ],
