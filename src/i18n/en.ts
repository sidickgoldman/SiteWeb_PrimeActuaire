...
export const en: Dictionary = {
  ...
  aProposPage: {
    ...
    heroDesc: "Expertise without the tool is an opinion.\nThe tool without expertise is a dashboard.\nPrimeActuaire is both.",
    ...
    valeursEyebrow: "Values",
    valeursTitle: "The principles that hold the analysis, even under pressure.",
    promesseEyebrow: "Promise",
    promesseTitle: "What you get, concretely.",
    valeurs: [
      { icon: "", title: "Confidentiality", desc: "Your data stays within the relationship." },
      { icon: "", title: "Rigour", desc: "Every assumption is defensible in committee." },
      { icon: "", title: "Clarity", desc: "Analysis speaks. Not jargon." },
      { icon: "", title: "Commitment", desc: "We measure our work by decisions enabled, not deliverables." },
      { icon: "", title: "Independence", desc: "Portfolio reality. Even under pressure." },
    ],
