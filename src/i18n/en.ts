...
export const en: Dictionary = {
  ...
  aProposPage: {
    ...
    valeurs: [
      { icon: "", title: "Actuarial rigor", desc: "Every figure is traceable and defensible in committee.\nAssumptions are documented. Always." },
      { icon: "", title: "Exclusive focus", desc: "Group health in the CIMA zone. One discipline.\nNo diversification. Mastered in depth." },
      { icon: "", title: "Decision speed", desc: "15 minutes for a complete diagnosis.\n3 days with manual methods.\nThe technical director shouldn't wait." },
      { icon: "", title: "Data sovereignty", desc: "Your data stays under your control.\nDedicated server. Full CIMA compliance." },
    ],
