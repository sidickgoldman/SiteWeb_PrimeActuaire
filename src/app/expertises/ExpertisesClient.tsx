  ...
  return (
    <>
      ...
      <main>
        ...
        {/* Approche conseil — 3 cartes */}
        <section className="bg-bg-light border-b border-navy/[0.06]">
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-3 divide-y lg:divide-y-0 lg:divide-x divide-navy/[0.07]">
              {(p.approach as { title: string; desc: string }[]).map((a, i) => (
                <motion.div
                  key={i}
                ...
                >
                  <span className="text-[11px] font-bold text-gold uppercase tracking-[3.5px] mb-6 block">
                    0{i + 1}
                  </span>
                  <h3 className="font-[var(--font-heading)] font-bold text-[1.2rem] text-navy leading-snug mb-4">
                    {a.title}
                  </h3>
